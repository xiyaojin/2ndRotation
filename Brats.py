...
model.fit_generator(generator=training_generator, validation_data=validation_generator,epochs=40,workers=4,verbose=1)

model.save_weights('/home/xjin/brats_dataset_slices/weights_11_17_40epochs.hdf5')

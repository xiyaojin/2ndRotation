...
loss=dice_coef_loss
filepath='/home/xjin/Brats_output/checkpoint_3d_12_13_2_{epoch:02d}.hdf5'
checkpointer=ModelCheckpoint(filepath,verbose=1,period=2)
...
model.fit_generator(generator=training_generator, validation_data=validation_generator,callbacks=callbacks_list,epochs=10,workers=4,verbose=1)

model.save_weights('/home/xjin/Brats_output/weights_3D_12_13_2.hdf5')

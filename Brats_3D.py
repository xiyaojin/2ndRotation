...
opt = Adam(lr=learning_rate_base, beta_1=0.9, beta_2=0.999, epsilon=1e-08)
#opt = SGD(lr=learning_rate_base, momentum=0.9)
loss=dice_coef_loss
filepath='/home/xjin/Brats_output/checkpoint_3d_12_16_{epoch:02d}.hdf5'
checkpointer=ModelCheckpoint(filepath,verbose=1,period=5)
...
hist=model.fit_generator(generator=training_generator, validation_data=validation_generator,callbacks=callbacks_list,epochs=200,workers=4,verbose=1)

model.save_weights('/home/xjin/Brats_output/weights_3D_12_16.hdf5')
loss_value=hist.history['loss']
val_loss_value=hist.history['val_loss']
np.save('/home/xjin/Brats_output/loss_3D_12_16.npy',loss_value)
np.save('/home/xjin/Brats_output/val_loss_3D_12_16.npy',val_loss_value)
